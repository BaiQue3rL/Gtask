...
const gachaApi: GachaApi = {
  ...
  recognizeScheduleImage: (target) => ipcRenderer.invoke('schedule-image:recognize', target),
  parseScheduleImageText: (input) => ipcRenderer.invoke('schedule-image:parse-text', input),
  applyScheduleImage: (input) => ipcRenderer.invoke('schedule-image:apply', input),
