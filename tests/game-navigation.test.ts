...
describe('sidebar game navigation', () => {
  ...
  it('formats a compact days-and-hours countdown and hides unavailable windows', () => {
    ...
    expect(isGameVersionDeadlineUrgent('2026-08-06T12:20:00.000Z', now)).toBe(true)
    expect(isGameVersionDeadlineUrgent('2026-08-06T12:20:00.001Z', now)).toBe(false)
    expect(gameVersionDeadlineTone('2026-08-06T12:20:00.000Z', now)).toBe('urgent')
    expect(gameVersionDeadlineTone('2026-08-06T12:20:00.001Z', now)).toBe('warning')
    expect(gameVersionDeadlineTone('2026-08-10T12:20:00.000Z', now)).toBe('warning')
    expect(gameVersionDeadlineTone('2026-08-10T12:20:00.001Z', now)).toBe('normal')
